...
awk '{gsub(/,0/, ",null")}1' ../data/CPI2012.csv > temp.csv
awk '{gsub(/null\./, "0\.")}1' temp.csv > temp2.csv
awk '{gsub(/null/, "")}1' temp2.csv > ../data/CPI2012_refined.csv
...
cat ../data/CPI2012_refined.csv >> temp_CPI2012.csv
mv temp_CPI2012.csv ../data/CPI2012_refined.csv
rm temp2.csv
rm temp.csv
