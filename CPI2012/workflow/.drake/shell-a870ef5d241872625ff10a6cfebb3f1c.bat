...
echo "Jena Fuseki was used to crate turtle file named /Users/renatostauffer/Desktop/FakeRetrieval_Transparency/tarql-0.9/bin/transparency-linked-data/CPI2012/workflow/turtleTransparency_final.ttl"
